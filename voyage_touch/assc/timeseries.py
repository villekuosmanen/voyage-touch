...
# 🚧 Under construction
# 🚧 Time series based ASSC models will enable support for sensors that produce readings when the state of the sensor changes.
# 🚧 Piezoelectric sensors are an example of this. 

class TimeSeriesASSC:
    """
    Time-series based Artificial somatosensory cortex.

    Predicts tactile events based on sensor data. Considers readings and predictions from the past.
    """
    ...
    def predict(self) -> np.array:
        ...
        """
        # TODO: add a list of past predictions either here or in the model itself
        return self.model.predict_timeseries(self.readings)
